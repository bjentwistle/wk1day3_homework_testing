...
#Given the length of a side of a cube calculate the volume
    def test_volume_of_cube(self):   
        volume_value = volume_of_cube(3)
        self.assertEqual(27, volume_value)


#Given a String, return the String reversed
    def test_reverse_string(self):
        reversed_string = reverse_string("Shaun is cool")
        self.assertEqual("looc si nuahS", reversed_string)
    

#Given a value in farenheit, convert this into celsius.
    def test_fahrenheit_to_celsius(self):
        converted_to_celsius = convert_to_celsius(350)
        self.assertEqual(176, converted_to_celsius)
